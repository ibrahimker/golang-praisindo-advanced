...
import (
	...
	postgres_gorm "github.com/ibrahimker/golang-praisindo-advanced/session-7-db-pg-gorm/repository/postgres_gorm"
	gorm "gorm.io/gorm"
)
...
func (m *MockGormDBIface) WithContext(ctx context.Context) postgres_gorm.GormDBIface {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WithContext", ctx)
	ret0, _ := ret[0].(postgres_gorm.GormDBIface)
	return ret0
}
